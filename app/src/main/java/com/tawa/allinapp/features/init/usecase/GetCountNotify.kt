...
class GetCountNotify
@Inject constructor(private val notifyRepository: NotifyRepository) : UseCase<Int, UseCase.None>() {

    override suspend fun run(params: None) = notifyRepository.getCountNotify()
