...
@Inject constructor(private val reportsRepository: ReportsRepository) : UseCase<Boolean, UpdateSkuDetail.Params>() {
    ...
    override suspend fun run(params: Params) = reportsRepository.updateSkuDetail(params.idSkuDetail,params.stock,params.exhibition,params.price)
    data class Params(val idSkuDetail: String,val stock:Boolean,val exhibition:Boolean,val price:Float)
}